...
class AIO_Tools {
    ...
    {
		include_once W2W_PUBLIC_PATH . 'section/w2w-contact-button.php';
		//include_once W2W_PUBLIC_PATH . 'section/w2w-smtp.php';
		include_once W2W_PUBLIC_PATH . 'section/w2w-header-footer.php';
		include_once W2W_PUBLIC_PATH . 'section/w2w-woocommerce.php';
	}
}