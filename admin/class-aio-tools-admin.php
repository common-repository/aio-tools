...
class AIO_Tools_Admin {
	...
	public function load_dependencies_frameworks() {
		require_once W2W_VENDOR_PATH . 'codestar-framework/codestar-framework.php';		
		require_once W2W_VENDOR_PATH . 'announce4wp/announce4wp-client.php';		
	}
	...
	public function create_settings_page() {		
		...
		if ( class_exists( 'CSF' ) ) {
			...
			require_once W2W_ADMIN_PATH . 'section/w2w-create-options.php';
			//require_once W2W_ADMIN_PATH . 'section/w2w-dashboard.php';
			require_once W2W_ADMIN_PATH . 'section/w2w-contact-button.php';
			//require_once W2W_ADMIN_PATH . 'section/w2w-smtp.php';
			require_once W2W_ADMIN_PATH . 'section/w2w-woocommerce.php';
			require_once W2W_ADMIN_PATH . 'section/w2w-header-footer.php';
			require_once W2W_ADMIN_PATH . 'section/w2w-tools.php';
