...
if ( ! defined( 'WPINC' ) ) {
				...
				[
					...
					'fields' => [
						...
						[
							...
							'type'	  => 'select',
							'title'	  => '',
							'desc'       => __( 'Mặc định hiển thị icon và text', 'w2w'),
							//'placeholder' => __( 'Hiển thị', 'w2w'),
							'options'     => [
								'icononly'  => __( 'Chỉ icon', 'w2w'),
								'icontext'  => __( 'Icon và text', 'w2w'),
							],
							'default'     => 'icontext'
						],
					],
				...
				[
					...
					'fields'    => [
						...
						[	
							...
							'validate' => 'csf_validate_phonenumber',
							'attributes'    => [
	...
	if( ! function_exists( 'csf_validate_phonenumber' ) ) {
	  function csf_validate_phonenumber( $value ) {
		if ( ! preg_match('/^[0-9]{10}+$/', $value)) {
		  return esc_html__( 'Chưa đúng định dạng', 'csf' );
		}
	  }
	}